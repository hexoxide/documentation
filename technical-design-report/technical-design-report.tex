...
The focus of the project is to deliver a scalable, performent and autonomously load balancing system. And also to conduct experiments to gather information about the reliability of the system.
...
\begin{center}
	\begin{figure}[H]
		\includegraphics[width=\textwidth]{"images/Effects of increased event rates on the loss for Round Robin with 2 FLPs"}
	\end{figure}
\end{center}
